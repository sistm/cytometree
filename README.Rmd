...
data. On top of the [CRAN help files](https://cran.r-project.org/package=cytometree/cytometree.pdf), we also provide a vignette illustrating the functionnalities of `cytometree`.
